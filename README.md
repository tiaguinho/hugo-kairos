...
Kairós is a clean, elegant, simple but not simpler blog theme for Hugo based on the original [LeaveIt Theme](https://raw.githubusercontent.com/liuzc/LeaveIt/) developed by [LiuZhichao](https://raw.githubusercontent.com/liuzc/) and [Ink Theme](https://github.com/knadh/hugo-ink) developed by [Kailash Nadh](https://github.com/knadh).

![hugo-theme-kairos](https://github.com/tiaguinho/hugo-kairos/blob/master/images/screenshot.png)
...
```bash
cd themes
git clone https://github.com/tiaguinho/hugo-kairos.git
```

Next, open config.toml in the base of the Hugo site and ensure the theme option is set to Kairós:
```bash
theme = "kairos"
```
...
* If you want to make your own theme toggle-able element, you can create an element with a class `.theme-switch`. See [here](https://github.com/tiaguinho/kairos/blob/master/assets/js/main.js#L32)
...
All feedback is welcome! Head over to the [issue tracker](https://github.com/tiaguinho/hugo-kairos/issues).

For more configuration info or other tips you can see the [wiki](https://github.com/tiaguinho/hugo-kairos/wiki).

# License
Kairós is licensed under the MIT license. Check the LICENSE file for details.
...
# Author
[tiaguinho](https://github.com/tiaguinho)
